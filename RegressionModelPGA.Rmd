...
summary(fit1)
```
he p-value are low (0.000285) and R-Squared is 0.3385. 
...
ets use the R function STEP to do the variable selection.
...
```{r,echo=TRUE}
## GRAPHIC FIGURE 1
plot(mpg ~ am, data = mtcars, main = "MPG BY TRANSMISSION TYPE (AM)", xlab = "Transmission Type (AM)", ylab = "Miles Per Gallon (MPG)",col="blue")
```
